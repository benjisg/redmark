/*
    Redmark: A rate limited work queue 
...
var defaultTime = 1000, /* Time interval to be broken up (milliseconds) */
      ...
      defaultMax = 1000, /* Maximum amount of time credits that can be built up in the pool (milliseconds) */
      defaultStart = 0; /* Number of time credits a pool should start with when initialized */
